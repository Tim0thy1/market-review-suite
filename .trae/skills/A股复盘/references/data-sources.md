...
| 编号 | Skill | 命令/调用 | 数据内容 |
| :--- | :--- | :--- | :--- |
| 14 | westock-data | `quote sh510300,sh510050,sh510500,sh512100,sh588000,sz159915,sh512000,sh512800 --raw` | 6只宽基ETF + 券商ETF + 银行ETF实时行情 |
| 15 | westock-data | `fund flow sh510300,sh510050,sh510500,sh512100,sh512000,sh512800` | 宽基ETF + 行业ETF主力资金流向 |
| 16 | westock-data | `kline sh510300 --period day --limit 10` | 宽基ETF近期K线（判断持续放量） |
| 17 | westock-data | `search 券商 --type sector` / `search 银行 --type sector` | 搜索券商/银行板块代码 |
| 18 | westock-data | `fund flow <板块代码>` | 券商/银行板块资金流向 |

**宽基ETF代码速查**：

| ETF名称 | 代码 | 跟踪指数 | 国家队操作频率 |
|---------|------|---------|--------------|
| 沪深300ETF华泰柏瑞 | sh510300 | 沪深300 | 最高（汇金首选） |
| 上证50ETF华夏 | sh510050 | 上证50 | 高（大盘蓝筹护盘） |
| 中证500ETF南方 | sh510500 | 中证500 | 中（中盘股支撑） |
| 中证1000ETF南方 | sh512100 | 中证1000 | 中（小盘股流动性） |
| 科创50ETF华夏 | sh588000 | 科创50 | 中（科技定向护盘） |
| 创业板ETF易方达 | sz159915 | 创业板指 | 中（创业板定向） |
| 券商ETF | sh512000 | 证券公司指数 | 高（情绪风向标） |
| 银行ETF | sh512800 | 中证银行指数 | 高（防御性护盘） |
